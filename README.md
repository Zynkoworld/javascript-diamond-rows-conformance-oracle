# zynko-oracle · `javascript-diamond-rows-conformance-oracle`

**A deterministic, re-checkable conformance oracle for `diamond` (javascript).**
...
## Provenance
Reference: the Exercism reference solution for `diamond` (javascript; MIT, Exercism), body unchanged. Proven by the exercism testsuite (pin=4223c46ff941b642), re-executed by harvest in a sealed sandbox (unshare -rn) before this bundle was generated.
